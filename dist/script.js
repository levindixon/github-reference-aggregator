...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ \"./node_modules/@babel/runtime/helpers/slicedToArray.js\");\n/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__);\n\n\n\n\nvar loadTokenFromChromeStorage = function loadTokenFromChromeStorage() {\n  return new Promise(function (resolve) {\n    chrome.storage.sync.get([\"token\"], function (_ref) {\n      var token = _ref.token;\n      resolve(token);\n    });\n  });\n};\n\nvar init = /*#__PURE__*/function () {\n  var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {\n    var token, _window$location$path, _window$location$path2, blank, repoOwner, repoName, issues, issueNumber, references, _responseJson$data, _responseJson$data$re, _responseJson$data$re2, _responseJson$data$re3, response, responseJson, linkedReferences;\n\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return loadTokenFromChromeStorage();\n\n          case 2:\n            token = _context.sent;\n\n            if (!(token === \"\")) {\n              _context.next = 5;\n              break;\n            }\n\n            return _context.abrupt(\"return\", console.warn(\"GitHub Reference Aggregator: Please specify a personal access token via the options page.\"));\n\n          case 5:\n            _window$location$path = window.location.pathname.split(\"/\"), _window$location$path2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_window$location$path, 5), blank = _window$location$path2[0], repoOwner = _window$location$path2[1], repoName = _window$location$path2[2], issues = _window$location$path2[3], issueNumber = _window$location$path2[4];\n            references = [];\n            _context.prev = 7;\n            _context.next = 10;\n            return fetch(\"https://api.github.com/graphql\", {\n              method: \"POST\",\n              headers: {\n                \"Content-Type\": \"application/json\",\n                Accept: \"application/json\",\n                Authorization: \"bearer \".concat(token)\n              },\n              body: JSON.stringify({\n                query: \"{\\n          repository(owner: \\\"\".concat(repoOwner, \"\\\", name: \\\"\").concat(repoName, \"\\\") {\\n            issue(number: \").concat(issueNumber, \") {\\n              timelineItems(first:250, itemTypes:[CROSS_REFERENCED_EVENT]) {\\n                nodes {\\n                  ... on CrossReferencedEvent {\\n                    actor {\\n                      login\\n                      url\\n                    }\\n                    source {\\n                      ... on Issue {\\n                        number\\n                        title\\n                        url\\n                      }\\n                      ... on PullRequest {\\n                        title\\n                        number\\n                        state\\n                        url\\n                      }\\n                    }\\n                  }\\n                }\\n              }\\n            }\\n          }\\n        }\\n      \")\n              })\n            });\n\n          case 10:\n            response = _context.sent;\n            _context.next = 13;\n            return response.json();\n\n          case 13:\n            responseJson = _context.sent;\n            references = responseJson === null || responseJson === void 0 ? void 0 : (_responseJson$data = responseJson.data) === null || _responseJson$data === void 0 ? void 0 : (_responseJson$data$re = _responseJson$data.repository) === null || _responseJson$data$re === void 0 ? void 0 : (_responseJson$data$re2 = _responseJson$data$re.issue) === null || _responseJson$data$re2 === void 0 ? void 0 : (_responseJson$data$re3 = _responseJson$data$re2.timelineItems) === null || _responseJson$data$re3 === void 0 ? void 0 : _responseJson$data$re3.nodes;\n            _context.next = 20;\n            break;\n\n          case 17:\n            _context.prev = 17;\n            _context.t0 = _context[\"catch\"](7);\n            return _context.abrupt(\"return\", console.error(\"GitHub Reference Aggregator: \".concat(_context.t0.message)));\n\n          case 20:\n            if (!(references.length === 0)) {\n              _context.next = 22;\n              break;\n            }\n\n            return _context.abrupt(\"return\", console.info(\"GitHub Reference Aggregator: No issue references found.\"));\n\n          case 22:\n            linkedReferences = document.createElement(\"details\");\n            linkedReferences.innerHTML = \"\\n  <summary>\\n    \\uD83D\\uDD17 References\\n  </summary>\\n  <br/>\\n  <table role=\\\"table\\\">\\n  <thead>\\n  <tr>\\n  <th>From</th>\\n  <th>By</th>\\n  <th>Link</th>\\n  </tr>\\n  </thead>\\n  <tbody>\\n  \".concat(references.map(function (d) {\n              return \"<tr><td>\".concat(d.source.state ? \"PR\" : \"Issue\", \"</td><td><a href=\\\"\").concat(d.actor.url, \"\\\">\").concat(d.actor.login, \"</a></td><td><a href=\\\"\").concat(d.source.url, \"\\\">\").concat(d.source.title, \" (#\").concat(d.source.number, \")</td></tr>\");\n            }).join(\"\"), \"\\n  </tbody>\\n  </table>\\n  \");\n            document.getElementsByClassName(\"comment-body\")[0].appendChild(linkedReferences);\n\n          case 25:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[7, 17]]);\n  }));\n\n  return function init() {\n    return _ref2.apply(this, arguments);\n  };\n}();\n\ninit();\n\n//# sourceURL=webpack:///./src/script.ts?");
